...
function mkIcon(paths) {
  return function Icon({
    ...
    return React.createElement('svg', {
      ...
      ...rest
    }, paths.map((d, i) => React.createElement(d.t || 'path', {
      key: i,
      ...d
    })));
  };
...
const CARDS = {
  ...
  freya: [{
    ...
    lv: 28,
    tp: 'N',
    n: "Guardian's Blessing",
    d: 'Heal 4 HP and 1 DR',
    fx: [{
      t: 'H',
      v: 4
    }, {
    ...
    lv: 29,
    tp: 'U',
    n: 'Avatar of Fortitude',
    d: 'Full Heal and 3 DR',
    fx: [{
      t: 'H',
      v: 999
    }, {
...
const INIT = {
  ...
  adminMsg: '',
  floaters: [],
  // [{id,x,y,text,color,big}]
  hitFlash: {},
  // {unitId: timestamp}
  playingCard: null,
  // {card, heroCl} for center-screen flourish
  banner: null,
  // {text, tone} phase-transition banner
  enemyQueue: [],
  // precomputed enemy actions to replay
...
function reducer(state, action) {
  ...
  switch (action.type) {
    ...
    case 'SELECT_PARTY_HERO':
      {
        ...
        if (already) return {
          ...s,
          party: s.party.filter(x => x !== action.id)
        };
        if (s.party.length >= 4) return s;
        return {
          ...s,
          party: [...s.party, action.id]
        };
      }
    case 'START_GAME':
      {
    ...
    case 'END_HERO_TURN':
      {
        const h = s.heroes.find(x => x.id === s.selectedHeroId);
        if (!h) return s;
        const newHeroes = s.heroes.map(x => x.id === h.id ? {
          ...x,
          done: true,
          dr: 0
        } : x);
        ...
        if (!allDone) {
          ...
          return {
            ...s,
            heroes: newHeroes,
            selectedHeroId: next?.id || null,
            selectedCard: null,
            moveRange: [],
            atkRange: [],
            log: ['Next hero.', ...s.log.slice(0, 19)]
          };
        }
        ...
        for (const enemy of simEnemies) {
          ...
          if (res.attackedHero && !s.godMode) {
            ...
            simHeroes = simHeroes.map(hh => hh.id === targetId ? {
              ...hh,
              hp: Math.max(0, hh.hp - dmg)
            } : hh);
    ...
    case 'ENEMY_STEP':
      {
        ...
        let newEnemies = s.enemies.map(e => e.id === step.enemyId ? {
          ...e,
          x: step.moveTo.x,
          y: step.moveTo.y
        } : e);
        ...
        if (step.attack) {
          ...
          newHeroes = s.heroes.map(hh => hh.id === targetId ? {
            ...hh,
            hp: Math.max(0, hh.hp - dmg)
          } : hh);
          newFloaters.push({
            id: `f${Date.now()}_${step.enemyId}`,
            x: tx,
            y: ty,
            text: `-${dmg}`,
            color: '#f87171',
    ...
    case 'END_ENEMY_PHASE':
      {
        ...
        const resetHeroes = s.heroes.map(h => ({
          ...h,
          done: false,
          dr: 0,
          cardPlayed: null,
        ...
        return {
          ...
          enemyQueue: [],
          round: s.round + 1,
          selectedHeroId: firstAlive?.id || null,
          selectedCard: null,
          moveRange: [],
          atkRange: [],
          banner: {
            text: `ROUND ${String(s.round + 1).padStart(2, '0')} \u2014 PLAYER PHASE`,
            tone: 'player'
          },
    ...
    case 'SET_NARRATOR':
      return {
        ...s,
        narratorSlide: action.i
      };
    case 'REMOVE_FLOATER':
      return {
        ...s,
        floaters: s.floaters.filter(f => f.id !== action.id)
      };
    case 'CLEAR_CARD_FLOURISH':
      return {
        ...s,
        playingCard: null
      };
...
function Btn({
  ...
  return /*#__PURE__*/React.createElement("button", {
    className: `btn ${cls} ${sm ? 'btn-sm' : ''} ${lg ? 'btn-lg' : ''}`,
    onClick: onClick,
    disabled: disabled,
    style: {
      fontFamily: 'inherit'
...
function TitleScreen({
  ...
  }, HEROES.slice(0, 6).map((h, i) => /*#__PURE__*/React.createElement("div", {
    key: h.id,
    style: {
      flex: 1,
      position: 'relative',
  ...
  }, "Magic Maidens Tactic"), /*#__PURE__*/React.createElement("div", {
    style: {
      fontSize: '.78rem',
      color: 'var(--txt3)',
      letterSpacing: '.1em',
  ...
  }, "New Campaign"), /*#__PURE__*/React.createElement(Btn, {
    cls: "btn-ghost",
    icon: BookOpen,
    onClick: () => dispatch({
      type: 'GO',
  ...
  }, "Knowledge Base"), /*#__PURE__*/React.createElement(Btn, {
    cls: "btn-ghost",
    icon: Settings,
    onClick: () => dispatch({
      type: 'GO',
  ...
  }, "Admin / Dev Tools")), /*#__PURE__*/React.createElement("div", {
    style: {
      display: 'flex',
      gap: 8,
      opacity: .6
...
function NarratorScreen({
  ...
  const NarrText = ({
    ...
    style: {
      ...
      fontStyle: 'italic',
      fontSize: 'clamp(.88rem,1.8vw,1.06rem)',
      lineHeight: 2.1,
      color: 'var(--txt)',
      textAlign: 'left',
      maxWidth: 560,
    ...
    }, line.text === '' ? '\u00A0' : line.text, isLast2 && !isDone && line.text !== '' && /*#__PURE__*/React.createElement("span", {
      style: {
  ...
  const TagLine = ({
    ...
    style: {
      flex: 1,
      height: '1px',
      background: 'linear-gradient(to right,transparent,rgba(251,191,36,.2))'
    }
    ...
    style: {
      flex: 1,
      height: '1px',
      background: 'linear-gradient(to left,transparent,rgba(251,191,36,.2))'
    }
  })) : null;
  const ProgressBar = () => /*#__PURE__*/React.createElement("div", {
    ...
    style: {
      height: '100%',
      background: 'linear-gradient(90deg,rgba(251,191,36,.35),rgba(251,191,36,.65))',
      transition: 'width .5s ease',
      width: `${(slide + 1) / NARR.length * 100}%`
    }
  }));

  // WHISPER
  if (cur.type === 'whisper') return /*#__PURE__*/React.createElement("div", {
    style: {
      position: 'fixed',
      inset: 0,
      background: '#000',
  ...
  }, cur.txt, /*#__PURE__*/React.createElement("div", {
    style: {
      marginTop: 36,
      fontSize: '.56rem',
      fontWeight: 500,
  ...
  // CHAPTER CARD
  if (cur.type === 'chapter') return /*#__PURE__*/React.createElement("div", {
    style: {
      position: 'fixed',
      inset: 0,
    ...
    style: {
      ...
      letterSpacing: '.44em',
      textTransform: 'uppercase',
      color: 'rgba(251,191,36,.42)',
      fontFamily: "'Outfit',sans-serif",
      marginBottom: 20
    }
  }, "Chapter ", cur.chapterNum), /*#__PURE__*/React.createElement("div", {
    style: {
      fontFamily: "'Fraunces',serif",
      fontStyle: 'italic',
      fontWeight: 700,
  ...
  }, cur.chapterTitle), /*#__PURE__*/React.createElement("div", {
    style: {
      width: 90,
      height: 1,
  ...
  // PARTY SLIDE
  if (cur.type === 'party') {
    if (!introShown) return /*#__PURE__*/React.createElement("div", {
      style: {
        display: 'flex',
        flexDirection: 'column',
        height: '100vh',
      ...
      tag: "Your Companions"
    }), /*#__PURE__*/React.createElement(NarrText, {
      lines: iVL,
      isDone: iDone
    }), /*#__PURE__*/React.createElement("div", {
      style: {
        ...
        textTransform: 'uppercase',
        color: 'rgba(255,255,255,.16)',
        animation: iDone ? 'pulse 1.8s ease-in-out infinite' : 'none',
        maxWidth: 560,
        margin: '24px auto 0'
      }
    }, iDone ? 'click to choose your companions' : 'click to skip'))), /*#__PURE__*/React.createElement("div", {
      style: {
        padding: '12px 24px',
    ...
    return /*#__PURE__*/React.createElement("div", {
    ...
    }, "Your Companions"), /*#__PURE__*/React.createElement("div", {
      style: {
        fontSize: '.7rem',
        color: 'var(--txt3)',
        marginTop: 2
      }
    }, "Who sits with you tonight? Choose 4 companions.")), /*#__PURE__*/React.createElement("div", {
      style: {
        marginLeft: 'auto',
        display: 'flex',
        alignItems: 'center',
      ...
      }, h ? /*#__PURE__*/React.createElement("img", {
        src: h.img,
        alt: "",
        style: {
          width: '100%',
    ...
    }, state.party.length, "/4"), /*#__PURE__*/React.createElement(Btn, {
      cls: "btn-gold",
      disabled: state.party.length < 4,
      icon: ChevronRight,
      onClick: next
    }, "Continue Story"))), /*#__PURE__*/React.createElement("div", {
      style: {
        marginTop: 8,
        padding: '5px 11px',
        borderRadius: 7,
      ...
      return /*#__PURE__*/React.createElement("div", {
        ...
        onClick: () => !full && dispatch({
          type: 'SELECT_PARTY_HERO',
          id: h.id
        })
      }, /*#__PURE__*/React.createElement("div", {
        style: {
      ...
      }, [['HP', h.hp, '#f87171'], ['AT', h.at, '#fbbf24'], ['MV', h.mv, '#2dd4bf'], ['RG', h.rg, '#a78bfa']].map(([l, v, c]) => /*#__PURE__*/React.createElement("div", {
        key: l,
        style: {
          textAlign: 'center'
        }
  ...
  }, done ? 'click anywhere to continue' : 'click to skip typing'))), /*#__PURE__*/React.createElement("div", {
    style: {
      position: 'relative',
      zIndex: 1,
      display: 'flex',
  ...
  }, slide + 1, " / ", NARR.length), /*#__PURE__*/React.createElement(Btn, {
    cls: done ? 'btn-gold' : 'btn-ghost',
    sm: true,
    icon: ChevronRight,
...
function BattleScreen({
  ...
  useEffect(() => {
    ...
    const justDied = [];
    heroes.forEach(h => {
      if (prevH.has(h.id) && h.hp <= 0) justDied.push(h.id);
    });
    enemies.forEach(e => {
      if (prevE.has(e.id) && e.hp <= 0) justDied.push(e.id);
    });
    if (justDied.length) {
      setDyingIds(prev => {
        const n = new Set(prev);
        justDied.forEach(id => n.add(id));
        return n;
      });
      justDied.forEach(id => {
        setTimeout(() => setDyingIds(prev => {
          const n = new Set(prev);
          n.delete(id);
          return n;
        }), 420);
  ...
  useEffect(() => {
    ...
    const timers = floaters.map(f => setTimeout(() => dispatch({
      type: 'REMOVE_FLOATER',
      id: f.id
    }), 900));
  ...
  useEffect(() => {
    ...
    let delay = 1200;
    queue.forEach(step => {
      timers.push(setTimeout(() => dispatch({
        type: 'ENEMY_STEP',
        step
      }), delay));
  ...
  return /*#__PURE__*/React.createElement("div", {
  ...
  }, String(round).padStart(2, '0'))), /*#__PURE__*/React.createElement("div", {
    style: {
      padding: '4px 12px',
      borderRadius: 20,
      fontSize: '.68rem',
    ...
    style: {
      ...
      borderRadius: 7,
      background: 'var(--bg2)',
      border: `1px solid ${h.hp > 0 ? h.cl + '44' : 'rgba(255,255,255,.05)'}`,
      opacity: h.hp > 0 ? 1 : .4
    }
  }, /*#__PURE__*/React.createElement("div", {
    style: {
  ...
  }, "KB"), /*#__PURE__*/React.createElement(Btn, {
    cls: "btn-ghost",
    sm: true,
    icon: Settings,
    onClick: () => dispatch({
    ...
    style: {
      position: 'relative',
      width: scenario.w * TILE,
      height: scenario.h * TILE
    }
  }, /*#__PURE__*/React.createElement("div", {
    style: {
      position: 'absolute',
    ...
    return /*#__PURE__*/React.createElement("div", {
      key: k,
      className: `tile ${isWall ? 't-wall' : isMove ? 't-move' : canAtk ? 't-atk' : ''}`,
      style: {
        width: TILE,
        height: TILE,
      ...
      onClick: () => {
        ...
        if (isMove) dispatch({
          ...
          x,
          y
        });else if (hero) dispatch({
          type: 'SELECT_HERO',
          id: hero.id
        });else if (canAtk) dispatch({
          type: 'ATTACK',
          id: enemy.id
        });
      }
    }, isWall && /*#__PURE__*/React.createElement("span", {
      style: {
        fontSize: '.7rem',
        opacity: .4
      }
    ...
    return /*#__PURE__*/React.createElement("div", {
      ...
      alt: "",
      onError: e => e.target.style.display = 'none'
    })), h.hp < h.mhp && h.hp > 0 && /*#__PURE__*/React.createElement("div", {
      style: {
        position: 'absolute',
        bottom: 1,
        left: '50%',
    ...
    return /*#__PURE__*/React.createElement("div", {
      ...
      onClick: () => !state.phaseAnimating && canAtk && dispatch({
        type: 'ATTACK',
        id: e.id
      })
    }, /*#__PURE__*/React.createElement("div", {
      className: `token ${canAtk ? 'token-sel' : ''}`,
      style: {
        borderColor: '#f87171',
        background: '#200a0a',
        fontSize: '.85rem',
  ...
  }), floaters.map(f => /*#__PURE__*/React.createElement("div", {
    key: f.id,
    className: "floater",
    style: {
    ...
    style: {
      ...
      boxShadow: playingCard.card.tp === 'U' ? '0 0 70px rgba(251,191,36,.35),0 20px 50px rgba(0,0,0,.6)' : '0 0 50px rgba(45,212,191,.2),0 20px 50px rgba(0,0,0,.6)'
    }
  }, /*#__PURE__*/React.createElement("div", {
    style: {
      fontSize: '.55rem',
  ...
  }, playingCard.card.tp === 'U' ? 'Ultimate' : 'Ability'), /*#__PURE__*/React.createElement("div", {
    style: {
      fontFamily: "'Fraunces',serif",
      fontStyle: 'italic',
      fontWeight: 700,
      fontSize: '1.15rem',
      color: playingCard.card.tp === 'U' ? '#fbbf24' : '#fff',
      lineHeight: 1.15,
      marginBottom: 8
    }
  }, playingCard.card.n), /*#__PURE__*/React.createElement("div", {
    style: {
      fontSize: '.72rem',
      color: 'var(--txt2)',
      lineHeight: 1.5
...
function CardRow({
  ...
  return /*#__PURE__*/React.createElement("div", {
    style: {
      display: 'grid',
      gridTemplateColumns: '22px 30px 160px 1fr',
      alignItems: 'center',
      gap: '0 7px',
      padding: '5px 8px',
      borderRadius: 5,
  ...
  }, card.lv), /*#__PURE__*/React.createElement("span", {
    className: card.tp === 'U' ? 'chip chip-u' : 'chip chip-n',
    style: {
      fontSize: '.52rem',
      padding: '1px 4px'
    }
  }, card.tp === 'U' ? 'ULT' : 'NRM'), /*#__PURE__*/React.createElement("span", {
    style: {
      fontSize: '.7rem',
      fontWeight: 600,
      whiteSpace: 'nowrap',
...
function HeroDetail({
  ...
  }, h.r))), /*#__PURE__*/React.createElement("div", {
    style: {
      display: 'grid',
      gridTemplateColumns: 'repeat(4,1fr)',
      borderBottom: '1px solid var(--border)'
    }
  }, [['HP', h.hp, '#f87171'], ['ATK', h.at, '#fbbf24'], ['MOV', h.mv, '#2dd4bf'], ['RNG', h.rg, '#a78bfa']].map(([l, v, c]) => /*#__PURE__*/React.createElement("div", {
    key: l,
    style: {
      padding: '9px 4px',
      textAlign: 'center',
  ...
  }, h.bi), /*#__PURE__*/React.createElement("div", {
    style: {
      fontSize: '.6rem',
      fontWeight: 700,
      letterSpacing: '.1em',
  ...
  }, "Playstyle"), /*#__PURE__*/React.createElement("p", {
    style: {
      fontSize: '.74rem',
      color: 'var(--txt2)',
      lineHeight: 1.72,
      borderLeft: '3px solid rgba(45,212,191,.35)',
      paddingLeft: 10
    }
  }, h.pl))), /*#__PURE__*/React.createElement("div", {
    style: {
      overflowY: 'auto',
      padding: 18
    }
  ...
  }, "Normal Cards", /*#__PURE__*/React.createElement("div", {
    style: {
      flex: 1,
      height: 1,
  ...
  }, cards.filter(c => c.tp === 'N').map(c => /*#__PURE__*/React.createElement(CardRow, {
    key: c.id,
    card: c
  }))), /*#__PURE__*/React.createElement("div", {
    style: {
  ...
  }, "Ultimate Cards", /*#__PURE__*/React.createElement("div", {
    style: {
      flex: 1,
      height: 1,
  ...
  }, cards.filter(c => c.tp === 'U').map(c => /*#__PURE__*/React.createElement(CardRow, {
    key: c.id,
    card: c
  })))));
}
function KnowledgeScreen({
  ...
  return /*#__PURE__*/React.createElement("div", {
  ...
  }, "Knowledge Base"), !kbHero && /*#__PURE__*/React.createElement("div", {
    style: {
      display: 'flex',
  ...
  }, ['heroes', 'monsters', 'mechanics'].map(tab => /*#__PURE__*/React.createElement("button", {
    key: tab,
    className: `tab ${kbTab === tab ? 'tab-active' : ''}`,
    style: {
      background: 'none',
      border: 'none',
      color: 'inherit',
  ...
  }, kbHero ? /*#__PURE__*/React.createElement(HeroDetail, {
    hero: kbHero
  }) : kbTab === 'heroes' ? /*#__PURE__*/React.createElement("div", {
    style: {
      overflowY: 'auto',
      height: '100%',
      padding: 14
  ...
  }, h.bi))))) : kbTab === 'monsters' ? /*#__PURE__*/React.createElement("div", {
    style: {
      overflowY: 'auto',
      height: '100%',
      padding: 16
  ...
  }, MONSTERS.map(m => /*#__PURE__*/React.createElement(Panel, {
    key: m.id
  }, /*#__PURE__*/React.createElement("div", {
    style: {
      display: 'flex',
    ...
    style: {
      ...
      borderRadius: '50%',
      background: `${m.cl}22`,
      border: `2px solid ${m.cl}55`,
      display: 'flex',
      alignItems: 'center',
      justifyContent: 'center',
      fontSize: '1.2rem'
    }
  }, m.ic), /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement("div", {
    style: {
      fontWeight: 700,
      color: m.cl,
      fontSize: '.82rem'
  ...
  }, "Enemy Unit"))), /*#__PURE__*/React.createElement("p", {
    style: {
      fontSize: '.73rem',
      color: 'var(--txt2)',
      lineHeight: 1.6,
  ...
  }, [['HP', m.hp, '#f87171'], ['ATK', m.at, '#fbbf24'], ['MOV', m.mv, '#2dd4bf'], ['RNG', m.rg, '#a78bfa']].map(([l, v, c]) => /*#__PURE__*/React.createElement("div", {
    key: l,
    style: {
      textAlign: 'center',
      padding: 5,
  ...
  }, [['Action Points (ATP)', 'Each hero gets 1 Move ATP + 1 Attack ATP per turn. Playing a card can grant bonus ATP. Use all actions before ending your turn.'], ['Ability Cards', 'Choose one ability card per turn before acting. Cards grant stat boosts, healing, damage reduction, or extra actions. Stats reset each turn.'], ['Movement', 'After playing a card, click Move to see reachable tiles highlighted in teal. Click a tile to move there.'], ['Combat', 'Click Attack after moving. Red tiles show enemies in range. RNG 1 = melee only, RNG 3+ = ranged attack.'], ['Damage Reduction', 'Some cards grant DR. Each point reduces incoming damage by 1. DR resets at the start of your next turn.'], ['Enemy Phase', 'After all heroes act, enemies move toward the nearest hero and attack if in range.']].map(([title, body]) => /*#__PURE__*/React.createElement(Panel, {
    key: title
  }, /*#__PURE__*/React.createElement("div", {
    style: {
      fontWeight: 700,
...
function AdminScreen({
  ...
  return /*#__PURE__*/React.createElement("div", {
  ...
  }, "Admin / Dev Tools"), /*#__PURE__*/React.createElement("span", {
    style: {
      marginLeft: 'auto',
      fontSize: '.64rem',
      padding: '2px 9px',
  ...
  }, adminMsg && /*#__PURE__*/React.createElement("div", {
    style: {
      padding: '7px 12px',
      borderRadius: 7,
  ...
  }, /*#__PURE__*/React.createElement(FastForward, {
    size: 13
  }), " Quick Navigate"), /*#__PURE__*/React.createElement("div", {
    style: {
      display: 'flex',
      flexWrap: 'wrap',
      gap: 5
    }
  }, [['Title', 'title'], ['Narrator', 'narrator'], ['Knowledge', 'knowledge']].map(([label, screen]) => /*#__PURE__*/React.createElement(Btn, {
    key: screen,
    cls: "btn-ghost",
    sm: true,
    onClick: () => {
  ...
  }, label)))), /*#__PURE__*/React.createElement(Panel, null, /*#__PURE__*/React.createElement("div", {
    style: {
      fontWeight: 700,
      color: '#f87171',
      marginBottom: 9,
    ...
    size: 13
  }), " Jump to Battle"), /*#__PURE__*/React.createElement("div", {
    style: {
      display: 'flex',
      gap: 6,
      marginBottom: 7
    }
  }, SCENARIOS.map((sc, i) => /*#__PURE__*/React.createElement(Btn, {
    key: sc.id,
    cls: "btn-red",
    sm: true,
    onClick: () => jumpBattle(i)
  }, sc.title.split('\u2014')[0].trim()))), /*#__PURE__*/React.createElement("div", {
    style: {
      fontSize: '.68rem',
      color: 'var(--txt3)'
    }
  }, "Uses current party or defaults to first 4 heroes.")), /*#__PURE__*/React.createElement(Panel, null, /*#__PURE__*/React.createElement("div", {
    style: {
      fontWeight: 700,
      color: '#2dd4bf',
      marginBottom: 9,
    ...
    size: 13
  }), " Hero Levels"), /*#__PURE__*/React.createElement("div", {
    style: {
      display: 'grid',
  ...
  }, h.n), /*#__PURE__*/React.createElement("select", {
    value: partyLevels[h.id] || 1,
    onChange: e => dispatch({
      type: 'SET_LEVEL',
      hid: h.id,
      lv: +e.target.value
  ...
  }, [1, 5, 10, 15, 20, 25, 30].map(lv => /*#__PURE__*/React.createElement("option", {
    key: lv,
    value: lv
  }, "Lv ", lv))))))), /*#__PURE__*/React.createElement(Panel, null, /*#__PURE__*/React.createElement("div", {
    style: {
      fontWeight: 700,
      color: '#fbbf24',
      marginBottom: 9,
    ...
    size: 13
  }), " Flags"), /*#__PURE__*/React.createElement("label", {
    style: {
      display: 'flex',
      alignItems: 'center',
      gap: 10,
    ...
    style: {
      position: 'absolute',
      top: 2,
      left: godMode ? 'calc(100% - 16px)' : 2,
      width: 12,
      height: 12,
      borderRadius: '50%',
      background: godMode ? 'var(--gold)' : 'rgba(255,255,255,.3)',
      transition: 'all .2s'
    }
  })), /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement("div", {
    style: {
  ...
  }, "Heroes cannot take damage")))), /*#__PURE__*/React.createElement(Panel, null, /*#__PURE__*/React.createElement("div", {
    style: {
      fontWeight: 700,
      color: '#a78bfa',
      marginBottom: 9,
...
function App() {
  ...
  function renderScreen() {
    switch (state.screen) {
      ...
      case 'narrator':
        return /*#__PURE__*/React.createElement(NarratorScreen, {
          state: state,
          dispatch: dispatch
        });
      case 'battle':
        return /*#__PURE__*/React.createElement(BattleScreen, {
          state: state,
          dispatch: dispatch
        });
      case 'knowledge':
        return /*#__PURE__*/React.createElement(KnowledgeScreen, {
          state: state,
          dispatch: dispatch
        });
      case 'admin':
  ...
  }, /*#__PURE__*/React.createElement("style", null, CSS), renderScreen());
}
