# Magic Maidens — Work Instructions & Progress

> เอกสารนี้ใช้ควบคุมการออกแบบ บันทึกสิ่งที่ตกลงแล้ว และระบุหัวข้อถัดไป
...
| Combat Design | Not started | รอ Story/Tutorial requirements เพิ่มเติม |
| Card Design | Not started | รอ Core Combat decision |
...
## 2026-08-19 — Initial Design Documents
