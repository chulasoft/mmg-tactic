...
# 1. Gameplay Design Topics

หัวข้อที่จะออกแบบใหม่ตามลำดับโดยรวม:
...
ใช้หน้า Party Selection เต็มรูปแบบเป็นส่วนหนึ่งของจังหวะการเล่าเรื่อง
โดยเข้าจากฉากโต๊ะและกลับไปเล่าการประชุมต่อหลังเลือกครบสี่คน

## 4.2 Interaction Flow

1. เปิดด้วย narration และเสียงเรียก
2. ตัดเข้าสู่ roster grid ที่มี silhouette แปดใบ
3. Hover/focus แล้ว portrait ของตัวละคร fade ขึ้น
4. เปิด Character Detail Panel พร้อมชื่อ Role จุดเด่น ค่าสถานะ และบทพูดสั้น
5. สอนว่า HP คือความทนทาน, ATK คือพลังโจมตี, MOV คือระยะเคลื่อนที่
   และ RNG คือระยะโจมตี
6. อนุญาตให้ยกเลิกและเลือกใหม่ก่อนยืนยัน
7. ปุ่มยืนยันล็อกไว้จนเลือกครบสี่คน
8. หลังยืนยัน กลับเข้าสู่ฉากโต๊ะและดำเนินบทสนทนาด้วยสมาชิกที่เลือกจริง
...
- การเน้นปีศาจทั้งหมดที่นับอยู่ใน Objective
- ข้อความอธิบายว่าต้องกำจัดศัตรูให้หมดเพื่อชนะ Scenario
...
- ตัวนับศัตรูที่ยังเหลืออยู่
- สถานะ `In progress` ระหว่างต่อสู้
- สถานะ `Complete` หลังชนะ
